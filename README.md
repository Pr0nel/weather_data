...
Este proyecto contiene un Jupyter Notebook para entrenar un modelo de predicción de radiación solar.
...
- `3.0 Evaluacion del modelo.ipynb`: Notebook para el análisis del modelo.
...
Para ejecutar la aplicación, primero debe generar el modelo de predicción ejecutando el notebook `Radiation.ipynb`.
